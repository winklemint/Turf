...
func AdminUpdateById(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "Error Finding Branch Id",
			"data":    nil,
		})
		return
	}
	...
	if result.Error != nil {
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "Failed To Updated Admin Details",
			"data":    nil,
		})
		return
	}
...
func AdminDelete(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "Unsuccessfully Deleted Staff",
			"data":    nil,
		})
		return
	}
...
func GetConfirmBookingTop5(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to get all branch details ",
			"data":    nil,
		})
		return
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": "Confirmed Booking Details",
		"data":    responseData,
	})
}
...
func Delete_Branch(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "Unsuccessfully Deleted Branch",
			"data":    nil,
		})
		return
	}

	var sl0t models.Time_Slot
	result = config.DB.Model(&sl0t).Where("branch_id=?", Id).Delete(&sl0t)
	if result.Error != nil {
		logrus.Infof("Failed to delete data from DB %v\n", result.Error)
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
	...
	result = config.DB.Model(&packages).Where("branch_id=?", Id).Delete(&packages)
	if result.Error != nil {
		logrus.Infof("Failed to delete data from DB %v\n", result.Error)
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
...
func AddPackage(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "Failed t0 create package",
			"data":    nil,
		})
		return
	}
	...
	for i := 0; i < len(body.Slot_id); i++ {
		...
		if result.Error != nil {
			...
			c.JSON(http.StatusBadRequest, gin.H{
				"status":  400,
				"message": "Relation Failed To Create",
				"data":    nil,
			})
...
func UpdateAdmin(c *gin.Context) {
	...
	if claims, ok := token.Claims.(jwt.MapClaims); ok && token.Valid {
		...
		if result.Error != nil {
			...
			c.JSON(http.StatusBadRequest, gin.H{
				"status":  400,
				"message": "Admin Update UnSuccessfully",
				"data":    nil,
			})
			return
		}
...
func UpdateSlot(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "Slot Update UnSuccessfully",
			"data":    nil,
		})
		return
	}
...
func GetAllSlot(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to get all slot",
			"data":    nil,
		})
		return
...
func Get_Slot_by_day(c *gin.Context) {
	...
	for i := 0; i < len(body.Day); i++ {
		...
		if result.Error != nil {
			...
			c.JSON(http.StatusBadRequest, gin.H{
				"status":  400,
				"message": "Failed To Get Slots For " + body.Day[i],
				"data":    nil,
			})
			return
		}
...
func UpdatePackage(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			...
			"status":  400,
			"message": "Package Update Unsuccessful",
			"data":    nil,
		})
		return
	}
...
func GetConfirmBooking(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  404,
			"message": "Failed To Get All Booking Details",
			"data":    nil,
		})
		return
	}
	...
	for i := 0; i < len(Pkg); i++ {
		...
		if result.Error != nil {
			...
			c.JSON(http.StatusBadRequest, gin.H{
				"status":  400,
				"message": "Failed To Get Slot Detail",
				"data":    nil,
			})
			return
		}
		...
		for _, s := range slot_id {
			...
			if result.Error != nil {
				...
				c.JSON(http.StatusBadRequest, gin.H{
					"status":  400,
					"message": "Failed To Find Slot By Start_Slot",
					"data":    nil,
				})
				return
			}
...
func UpdatecomfirmDetails(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "Confirm Table Update UnSuccessfully",
			"data":    nil,
		})
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": "confirm table Update Successfully",
...
func CountUser(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "Total User Count Unsuccessfully",
			"data":    nil,
		})
		return
	}
...
func GetMonthlyUsers(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "Failed to retrieve monthly user counts",
			"data":    nil,
		})
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{
		"status":      200,
		"message":     "Monthly Users Successfully Retrieved",
...
func Today_Total_Booking(c *gin.Context) {
	...
	if result.Error != nil || count == 0 {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "Today Total  Booking Unsuccessfully",
			"data":    0,
		})
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": "Today Total  Booking Successfully",
		"data":    count,
	})
}
...
func AdminAddScreenshot(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "Invalid Request To Payload",
			"data":    nil,
		})
		return
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to insert screeshot",
			"data":    nil,
		})
		return
	} else {
		...
		if status.Error != nil {
			...
			c.JSON(http.StatusBadRequest, gin.H{
				"status":  400,
				"message": "failed to upadte confirm boooking details",
				"data":    nil,
			})
			return
		}
		...
		if result.Error != nil {
			...
			c.JSON(http.StatusBadRequest, gin.H{
				"status":  400,
				"message": "failed to upadte boooking details",
				"data":    nil,
			})
			return
		}
...
func AddSlotForUser(c *gin.Context) {
	...
	if rows.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to add slot for user",
			"data":    nil,
		})
		return
	}
	...
	if len(availableSlots) == 0 {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "Slot is allready booked",
			"data":    nil,
		})
	}
}
...
func Testimonials(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": "testimonials create successfully",
		"data":    testimonial,
	})
}
func Upadte_Testimonials(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to Update testimonials Details",
			"data":    nil,
		})
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": "Testimonials Upadted Successfully",
		"data":    testimonial,
	})
...
func UpdateImageForTestimonials(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to update testimonials Image",
			"data":    nil,
		})
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": "testimonials Image updated successfully",
		"data":    testimonial,
	})
}
func UpdateImageForTestimonials2(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": "testimonials Images updated successfully",
		"data":    testimonial,
	})
}
func AllTestimonials(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": "testimonials details fetch successfully",
		"data":    testimonials,
	})
...
func GETTestimonialsimagesById(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to fetch testimonial image",
			"data":    nil,
		})
		return
	}
...
func DeleteTestimonials(c *gin.Context) {
	...
	if result.RowsAffected == 0 {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "unsuccessfully Deleted Testimonial",
			"data":    nil,
		})
		return
	}
...
func DeleteContent(c *gin.Context) {
	...
	if result.RowsAffected == 0 {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "unsuccessfully Deleted content",
			"data":    nil,
		})
		return
	}
...
func AddImageForCarousel(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "Failed to add image for carousel",
			"data":    nil,
		})
		return
	}
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": "Success to add image for carousel",
		"data":    carousel,
	})
}
func GetAllImageCarousel(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "Failed to get all carousel",
			"data":    nil,
		})
		return
	}
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": "Success to get all carousel",
		"data":    carousel,
	})
...
func GetActiveImageCarousel(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "Failed to get active carousel",
			"data":    nil,
		})
		return
	}
...
func UpadtecarouselImage(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to update image for carousel",
			"data":    nil,
		})
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": "carousel updated image for successfully",
		"data":    carousel,
	})
}
func DeleteCarousel(c *gin.Context) {
	...
	if result.RowsAffected == 0 {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "unsuccessfull t0 Delete Carousel",
			"data":    nil,
		})
		return
	}
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": "successfully Deleted  Carousel",
		"data":    nil,
	})
}
...
`, branchid).Scan(&packages)
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": "package names and slots",
		"data":    response,
	})
}
...
func GETCarouselActiveImages(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to fetch active image for carousels",
			"data":    nil,
		})
		return
	}
...
func RemainingPaymentForUser(c *gin.Context) {
	...
	if result.RowsAffected == 0 {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "No matching booking details found",
			"data":    nil,
		})
		return
	}
...
func Pending_bookings(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": "pending booking details",
		"data":    response,
	})
}
...
`, ID).Scan(&bookings)
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": "Pending booking details by id",
		"data":    response,
	})
}
...
func GetpaymentimagesById(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to fetch Payment Image",
			"data":    nil,
		})
		return
	}
...
func AddNavbar(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": "navbar add successfully",
		"data":    navbar,
	})
...
func GetAllNavbar(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to Get Navbar Details",
			"data":    nil,
		})
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": " Get Navabar Details successfully",
		"data":    navbars,
	})
}
func GetActiveNavbar(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to Get active Navbar Details",
			"data":    nil,
		})
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": " Get active Navabar Details successfully",
		"data":    navbars,
	})
}
...
func DeleteNavbar(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to Delete Navbar Details",
			"data":    nil,
		})
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": " Delete Navabar Details successfully",
		"data":    nil,
	})
}
...
func GetAllHeading(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to Get Headings Details",
			"data":    nil,
		})
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": " Get Headings Details successfully",
		"data":    headings,
	})
}
func GetActiveHeading(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to Get Avtive Heading Details",
			"data":    nil,
		})
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": " Get Active Heading Details successfully",
		"data":    headings,
	})
}
...
func GetHeadingById(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to Get Heading Details",
			"data":    nil,
		})
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": " Get Heading Details successfully",
		"data":    heading,
	})
}
func DeleteHeading(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to Delete Heading Details",
			"data":    nil,
		})
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": " Delete Heading Details successfully",
		"data":    nil,
	})
}
...
func Total_Remaining_amount(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  404,
			"message": "failed to get Total_Remaining_amount ",
			"data":    nil,
		})
		return
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": "Total_Remaining_amount",
...
func Total_Monthly_revenue(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": "m0nthly revenue details",
		"data":    totalPaidAmount,
	})
}
...
func GetAllIcon(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": " Get Icon Details successfully",
		"data":    icons,
	})
}
func GetActiveIcon(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to Active Icon Details",
			"data":    nil,
		})
		return
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": " Get Active Icon Details successfully",
		"data":    icons,
	})
}
...
func DeleteIcon(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to Delete Icon Details",
			"data":    nil,
		})
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": " Delete Icon Details successfully",
		"data":    nil,
	})
}
...
func Get_Available_slots_Multi_Dates(c *gin.Context) {
	...
	for currentDate := startDate; currentDate.Before(endDate) || currentDate.Equal(endDate); currentDate = currentDate.AddDate(0, 0, 1) {
		...
		if result.Error != nil {
			c.JSON(http.StatusBadRequest, gin.H{
				"status":  400,
				"message": "Failed to find booked slots for date",
				"data":    nil,
			})
			return
		}
		...
		for _, slot := range slots {
			...
			if result.Error != nil {
				c.JSON(http.StatusBadRequest, gin.H{
					"status":  400,
					"message": "Failed to find Package_slot_relationship for slot",
					"data":    nil,
				})
				return
			}
			...
			if result.Error != nil {
				c.JSON(http.StatusBadRequest, gin.H{
					"status":  400,
					"message": "Failed to find Package for slot",
					"data":    nil,
				})
				return
			}
	...
	c.JSON(http.StatusOK, gin.H{
		"status":          200,
		"message":         "Available slots for dates",
...
func MultipleImages(c *gin.Context) {
	...
	if result.Error != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "failed to fetch screenshot image",
			"data":    nil,
		})
		return
	}
...
func PackageNameList(c *gin.Context) {
	...
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "Failed to retrieve Branch ID from cookie",
			"data":    nil,
		})
		return
	}
	...
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "Invalid Branch ID in cookie",
			"data":    nil,
		})
		return
	}
	...
	if result.Error != nil {
		c.JSON(http.StatusBadRequest, gin.H{
			"status":  400,
			"message": "Failed to get Package Name List",
			"data":    nil,
		})
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{
		"status":  200,
		"message": "Successfully retrieved Package Name List",
		"data":    packages,
	})
}
